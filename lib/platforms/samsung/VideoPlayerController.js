(function(exports){
  ...
  let VideoPlayerController = function(){
     ...
     * Helpers
     */ 
    this.appendAppDomainandAppBundle = (url) => {
    	
    	let URLObj = new URL(url);
    	
    	let checkBundle = URLObj.searchParams.get("app_bundle");
    	let checkDomain = URLObj.searchParams.get("app_domain");
    	
    	if(checkBundle == ""){
    		URLObj.searchParams.set("app_bundle", appDefaults.packageId);
    	}
    	if(checkDomain == ""){
    		URLObj.searchParams.set("app_domain", appDefaults.packageId);
    	}
    ...
    this.prepareAVPlayer = () => {
      ...
      source.url = _this.appendAppDomainandAppBundle(source.url);
