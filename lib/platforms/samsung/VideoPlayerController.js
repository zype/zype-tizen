				...
				webapis.avplay.prepareAsync(
					function(){
						if (!_this.playerClosed) {
							...
							let adTag = "https://pubads.g.doubleclick.net/gampad/ads?sz=640x360&iu=/4312434/consott/conszype&cust_params=vid%3Dtest9999999999%26pt%3D1676%26pl%3Dtest9999999999%26leaf%3Dtest9999999999%26env%3D1&impl=s&gdfp_req=1&env=vp&output=vast&unviewed_position_start=1";
							AdsService.requestAd(adTag, _this.pauseVideo, _this.playVideo);
						}
						else {
							hideSpinner();
						}
